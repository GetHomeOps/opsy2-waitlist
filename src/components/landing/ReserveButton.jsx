...
export function ReserveButton({
  ...
  const classes = [
    "inline-flex cursor-pointer items-center justify-center rounded-full px-7 py-3 text-center text-[0.95rem] font-semibold tracking-wide transition-[color,background-color,transform,box-shadow] duration-300 ease-out",
